    ...
    <div className='content-container'>
      ...
      <div className='row'>
        <div className='col-12 text-center'>
          <h1 className='cse-heading' data-aos='fade-up' data-aos-delay='100'>CES Department</h1>
          <h1 className='engineering-heading' data-aos='fade-up' data-aos-delay='100'>Computer Science Engineering</h1>
        </div>
          <div className='contair-color size1 col-12  col-md-6'>
            <h1 className='cse-department-heading' data-aos='fade-up' data-aos-delay='100'>CSE Department</h1>
            <hr className='horizontal-line' />
          <ul className='size1-list' data-aos='fade-rifht' data-aos-delay='100'>
            <li data-aos='fade-up' data-aos-delay='100'><BiRightArrowAlt size="25" /><span>About CSE Department</span></li>
